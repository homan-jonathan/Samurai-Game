...
public class SettingsScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _crouch.GetComponentInChildren<Text>().text = KeyBinding.crouch().ToString();
        _cameraMode.GetComponentInChildren<Text>().text = KeyBinding.cameraMode().ToString();
        _jump.GetComponentInChildren<Text>().text = KeyBinding.jump().ToString();
    }
